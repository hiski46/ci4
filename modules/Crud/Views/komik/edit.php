...
<div class="container">
    <div class="row">
        <div class="col-8">
            ...
            <form action="/crud/komik/update/<?= $komik['id']; ?>" method="post" class="" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="row mb-3">
                ...
                <!-- slug -->
                <input type="hidden" class="form-control" name="slug" id="slug" value="<?= $komik['slug']; ?>">
                <input type="hidden" class="form-control" name="sampulLama" value="<?= $komik['sampul']; ?>">
